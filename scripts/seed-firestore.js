/**
 * seed-firestore.js
 * Popula restaurants/don-ferrari/data/{businessInfo,cardapio,promocoes}
...
async function seed() {
  ...
  // Garante que o doc pai restaurants/don-ferrari existe com os metadados mínimos
