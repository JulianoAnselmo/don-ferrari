 ...
 *   Programa: node
 *   Argumentos: "C:\dev\prototipos\don ferrari\scripts\sync-eatfood.js"
...
var SLUG = 'don-ferrari';
var PROJECT = 'cardapio-admin-prod';
var EATFOOD_URL = 'https://apionline.com.br:8443/v1/carganome/donferraripizzariataquaritinga';
...
async function run() {
  ...
  if (!docSnap.exists) {
    ...
    var businessInfo = {
      ...
      cep: '15900-001',
      instagram: store.linkinstagram ? 'https://www.instagram.com/' + String(store.linkinstagram).replace(/^@+/, '') : 'https://www.instagram.com/donferrari',
      facebook: store.linkfacebook && String(store.linkfacebook).trim() ? 'https://www.facebook.com/' + String(store.linkfacebook).trim() : '',
      googleMapsLink: '',
      googleMapsEmbed: '',
      hours: {
