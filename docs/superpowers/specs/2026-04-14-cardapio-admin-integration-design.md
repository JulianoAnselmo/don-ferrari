# Design: Integrar Don Ferrari com Cardapio Admin

## Contexto

O site Don Ferrari (vanilla HTML/CSS/JS) usa dados de cardapio hardcoded em `data/menu.js`.
O objetivo e integra-lo com o sistema **Cardapio Admin** (React/Firebase), que gerencia
cardapios de restaurantes via Firestore. Slug: `don-ferrari`.

Os dados do cardapio real foram extraidos da API EatFood (`apionline.com.br:8443/v1/carganome/donferrari`) — 279 produtos em 15 categorias.
...
```js
{
  ...
  cep: "15900-053",
  instagram: "https://www.instagram.com/donferrari",
  facebook: "",
  googleMapsLink: "",
  googleMapsEmbed: "",
  hours: {
...
Endpoint: `restaurants/don-ferrari/data/{docName}`
...
Responsabilidades:
- Configuracao: `SLUG = 'don-ferrari'`, `PROJECT = 'cardapio-admin-prod'`
...
var businessInfoData = {
  name: "Don Ferrari", whatsappNumber: "551632526169", ...
};
```
...
### Teste do admin
- Abrir cardapio-admin, acessar restaurante `don-ferrari`
